...
class BasePage:
    ...
    def click(self, locator):
        if str(locator).endswith("_Xpath"):
            self.driver.find_element(By.XPATH, ConfigReader.readconfig("locator_RegistrationPage", locator)).click()
    ...
    def select(self, locator, value):
        ...
        if str(locator).endswith("_Xpath"):
            ...
            dropdown = self.driver.find_element(By.CSS_SELECTOR,
                                                ConfigReader.readconfig("locator_RegistrationPage", locator))
        elif str(locator).endswith("_ID"):
